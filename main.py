...
categories = {
    "대학 홈페이지": {
        "서울대학교": {
            ...
            "desc": "서울대학교 공식 홈페이지. 대학 정보, 학과 안내 확인 가능."
        },
        "서울대학교 입학처": {
            "link": "https://admission.snu.ac.kr/",
            "desc": "서울대 입학 정보 제공. 학과 소개와 입시 요강 확인 가능."
        },
        "고려대학교": {
            "link": "https://www.korea.ac.kr/",
            "desc": "고려대학교 공식 홈페이지. 대학 정보, 학과 안내 확인 가능."
        },
        "고려대학교 입학처": {
            "link": "https://oku.korea.ac.kr/",
            "desc": "고려대 입학처 공식 사이트. 입학 전형, 학사 안내 확인 가능."
        },
        "연세대학교": {
            "link": "https://www.yonsei.ac.kr/",
            "desc": "연세대학교 공식 홈페이지. 대학 정보, 학과 안내 확인 가능."
        },
        "연세대학교 입학처": {
        ...
        "성균관대학교": {
            ...
            "desc": "성균관대학교 공식 홈페이지. 대학 정보, 학과 안내 확인 가능."
        },
        "성균관대학교 입학처": {
        ...
        "KAIST": {
            ...
            "desc": "KAIST 공식 홈페이지. 대학 정보, 학과 안내 확인 가능."
        },
        "KAIST 입학처": {
